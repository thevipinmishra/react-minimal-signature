      ...
      <nav className="bg-cyan-50 py-10">
        <div className="max-w-4xl w-full mx-auto px-8 flex items-center gap-4 flex-col">
          ...
          <p className="text-sm text-cyan-900 text-center">
            Deprecated. Use SignetPad instead.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <a
              ...
              className="bg-cyan-900 inline-flex min-h-10 transition-colors hover:bg-cyan-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-1 gap-2 text-sm items-center text-cyan-50 px-3 py-2 rounded-md"
            >
              Use SignetPad
            </a>
            <a
              href="https://github.com/thevipinmishra/react-signature-pad"
              target="_blank"
              rel="noreferrer noopener"
              className="bg-white border border-cyan-900 inline-flex min-h-10 transition-colors hover:bg-cyan-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-1 gap-2 text-sm items-center text-cyan-950 px-3 py-2 rounded-md"
            >
              <svg
                viewBox="0 0 256 250"
                className="size-4"
