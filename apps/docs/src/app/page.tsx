      ...
      <nav className="bg-cyan-50 py-10">
        <div className="container flex items-center gap-4 flex-col">
          ...
          <a
            ...
            className="bg-cyan-900 inline-flex transition-colors hover:bg-cyan-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-1  gap-2 text-sm items-center text-cyan-50 px-3 py-2 rounded-md "
          >
            <svg
              viewBox="0 0 256 250"
              className="size-4"
